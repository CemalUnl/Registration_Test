...
/**Test  26 **/           
        ...
        System.out.printf("%nActual output:   %s", comp1008.addStudent2(st5));
        if (comp1008.addStudent2(st5).equals("Student was not added because the course is full")) {
            marks++;
        } else {
...
/**Test   40 **/   
        ...
        System.out.printf("%nActual output:   student %s, has completed the following courses: %s", st1.getStudentNo(), st1.getCompletedCourses());
